...
INSERT INTO `item` VALUES (1,'Pepsi','',1,22),(2,'coke-cool','desc',2,22),(3,'Fanta','Cool',3,24);
...
INSERT INTO `item_rate` VALUES (1,1,10,'2022-07-03 05:10:14'),(2,2,45,'2022-07-03 05:39:29'),(3,2,55,'2022-07-03 05:52:16'),(4,3,8.9,'2022-07-17 05:08:00'),(6,3,100,'2022-07-17 05:17:18');
...
--
/*!50003 DROP PROCEDURE IF EXISTS `delete_item_proc` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `delete_item_proc`(IN pItemID int,OUT rRes BOOLEAN,OUT rMsg varchar(50))
BEGIN
    SET rRes := true;
    SET rMsg := '';
	delete from item where ITEM_ID = pItemID;
    delete from item_rate where RATE_ITEM_ID = pItemID;
END ;;
DELIMITER ;
...
-- Dump completed on 2022-07-17 11:01:59
